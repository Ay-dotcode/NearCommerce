...
// Enums
export const UserRoleSchema = z.enum(["CUSTOMER", "STORE_OWNER", "SYSTEM_ADMIN"]);
...
export const AddHouseholdListItemSchema = z.object({
...
.refine((data) => (data.storeId && !data.productId) || (!data.storeId && data.productId), {
...
export type AddHouseholdListItemInput = z.infer<typeof AddHouseholdListItemSchema>;
